...
using Dragonfly.Engine.Procedural;
...
namespace Dragonfly.Engine.Test.GraphicTests
{
    public class ProceduralTest : GraphicsTest
    {
        ...
        public override void CreateScene()
        {
            ...
            CompLightDirectional sun = new CompLightDirectional(CompTransformStack.FromDirection(Context.Scene.Root, new Float3(1.0f, -0.5f, 1.0f)), new Float3("#f9f6e0"), 2.0f);
            sun.CastShadow = true;
        ...
        private void InitializeMaterialPresets()
        {
            ...
            materiaPresets[1].Factory = new CompMtlGBuffer.Factory(CompMtlGBuffer.Type.TangentSpaceNormalMap) { MaterialClass = baseMod.MainPass.MainClass };
            materiaPresets[1].BackgroundColor = new Float3(0.5f, 0.5f, 1.0f);
            // albedo map display preset
            materiaPresets[2].Factory = new CompMtlGBuffer.Factory(CompMtlGBuffer.Type.Albedo) { MaterialClass = baseMod.MainPass.MainClass };
            materiaPresets[2].BackgroundColor = new Float3(1.0f, 0, 1.0f);
            // roughness map display preset
            materiaPresets[3].Factory = new CompMtlGBuffer.Factory(CompMtlGBuffer.Type.Roughness) { MaterialClass = baseMod.MainPass.MainClass };
            materiaPresets[3].BackgroundColor = Color.Gray.ToFloat3();
            // translucency map display preset
            materiaPresets[4].Factory = new CompMtlGBuffer.Factory(CompMtlGBuffer.Type.Translucency) { MaterialClass = baseMod.MainPass.MainClass };
