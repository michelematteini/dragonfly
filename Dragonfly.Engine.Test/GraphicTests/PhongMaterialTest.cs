...
namespace Dragonfly.Engine.Test.GraphicTests
{
    public class PhongMaterialTest : GraphicsTest
    {
        ...
        public override void CreateScene()
        {
            ...
            // create objects
            CompTransformStack objTransform = new CompTransformStack(root, Float4x4.RotationY(-0.4f));
            ...
            lightsRotation.PushRotationY(new CompTimeSeconds(lightsRotation), 0.4f);
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                Float3 color = rnd.NextSatColor().Lerp(Float3.One, 0.3f);
                new CompLightPoint(CompTransformStack.FromPosition(lightsRotation, pos), color);
