...
namespace Dragonfly.Engine.Test.GraphicTests
{
    public class ViewportTest : GraphicsTest
    {
        ...
        public override void CreateScene()
        {
            ...
            CompTransformStack rotation = new CompTransformStack(Context.Scene.Root, Float4x4.Scale(3.0f));
            ...
            // create camera 1
            CompCamPerspective camera1 = new CompCamPerspective(CompTransformStack.FromLookAt(Context.Scene.Root, new Float3(0, 5.0f, 20.0f), new Float3(0, 0, 0)));
            camera1.Viewport = new AARect(0, 0, 0.49f, 0.49f);
            mainPass.CameraList.Add(camera1);

            // create camera 2
            CompCamPerspective camera2 = new CompCamPerspective(CompTransformStack.FromLookAt(Context.Scene.Root, new Float3(0, 20.0f, 5.0f), new Float3(0, 0, 0)));
            camera2.Viewport = new AARect(0.51f, 0, 1, 0.49f);
            mainPass.CameraList.Add(camera2);

            // create camera 3
            CompCamPerspective camera3 = new CompCamPerspective(CompTransformStack.FromLookAt(Context.Scene.Root, new Float3(20.0f, 5.0f, 0), new Float3(0, 0, 0)));
            camera3.Viewport = new AARect(0, 0.51f, 0.49f, 1);
            mainPass.CameraList.Add(camera3);

            // create camera 4
            CompCamPerspective camera4 = new CompCamPerspective(CompTransformStack.FromLookAt(Context.Scene.Root, new Float3(15.0f, -15.0f, 15.0f), new Float3(0, 0, 0)));
