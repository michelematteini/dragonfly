...
namespace Dragonfly.Engine.Test.GraphicTests
{
    public class PhysicalMaterialTest : GraphicsTest
    {
        ...
        public override void CreateScene()
        {
            ...
            baseMod.PostProcess.ExposureValue = ExposureHelper.EVPartlyCloudy;

            // create camera
            camera = new CompCamPerspective(CompTransformStack.FromLookAt(Context.Scene.Root, new Float3(0, 0.5f, 3.0f), new Float3(0, 0, 0)));
            ...
            // lights
            CompLightDirectional sun = new CompLightDirectional(CompTransformStack.FromDirection(Context.Scene.Root, new Float3(-1.0f, -0.9f, -1.0f)), new Float3("#f9f6e0"), ExposureHelper.LuxInDirectSunlight);
